<template>
  ...
  <el-divider/>
  <h3>完全自定义控制栏</h3>
  <zh-hlsPlayer src="https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8">
  ...
  <el-divider/>
  <h3>完全自定义控制栏</h3>
  <zh-hlsPlayer src="/stream.m3u8" @error="handleError">
  ...
  <el-divider/>
  <h3>使用默认空件</h3>
  <zh-hlsPlayer autoplay src="https://test-streams.mux.dev/x36xhzz/x36xhzz.m3u8" :controls="false" :default-controls="true">
  </zh-hlsPlayer>
</template>
