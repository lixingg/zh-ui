...
<template>
  <div class="demo-container">
    <div class="toolbar">
      <el-button size="small" type="primary" @click="addMarkers">添加打点</el-button>
      <el-button size="small" type="success" @click="addPolyline">添加画线</el-button>
      <el-button size="small" type="warning" @click="addPolygon">添加画面</el-button>
      <el-button size="small" type="danger" @click="addHeatmap">添加热力图</el-button>
      <el-button size="small" type="info" @click="startVehicle">启动车辆轨迹</el-button>
      <el-button size="small" type="default" @click="startFlight">启动飞行轨迹</el-button>
      <el-button size="small" type="danger" @click="clearAll">清空所有图层</el-button>
    </div>
    <zh-cmap
        ref="mapRef"
...
function onMapReady(viewer: any) {
  console.log('Cesium ready', viewer)
}
...
function addPolygon() {
  polygons.value = [
    {
      id: 'p1',
      positions: [{lng: 116.3, lat: 39.8}, {lng: 116.5, lat: 39.8}, {lng: 116.5, lat: 39.9}, {lng: 116.3, lat: 39.9}],
      color: '#00FF00'
    }
  ]
}
...
function onMarkerClick(entity: any) {
