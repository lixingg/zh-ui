...
<show-code showPath="button/disabledButtonShow">
...
<show-code showPath="button/textButtonShow">
...
<show-code showPath="button/groupButtonShow">
<groupButtonShow></groupButtonShow>
</show-code>
...
<show-code showPath="button/loadingButtonShow">
...
<show-code showPath="button/sizeButtonShow">
...
| 属性 | 说明 | 类型 | 可选值 | 默认值 |
| - | - | - | - | - |
| size | 用于控制该按钮组内按钮的大小 | string | 与按钮同名属性相同 | default |
| type | 用于控制该按钮组内按钮的类型 | string | 与按钮同名属性相同 | default |
