...
| useOfdPreview   | 使用带有tools组件的预览（useOfdViewer都为false，默认使用liteofd手动渲染） | boolean | --  | false  |
| useOfdViewer    | 使用预览多页面组件  （useOfdPreview都为false，默认使用liteofd手动渲染）   | boolean | --  | false  |
