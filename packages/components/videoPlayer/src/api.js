...
const API = {
    ...
    */
    getRealmonitor(realmonitorParam) {
        console.log(realmonitorParam)
        let myData = {
            // url:realmonitorParam.url,
            // token: realmonitorParam.url.split('?')[1].split('=')[1]
            url: "rtsp://112.46.235.84:11203/dss/monitor/param/cameraid=1000008%247%26substream=1",
            token: "535"
        }
        console.log('getRealmonitor=====',myData)
        // return realmonitorParam.param
        return new Promise((resolve,reject) => {
            resolve(myData)
            // API.ajaxRequest({
            //     url: '/api/back/monitor/jkRegionList',
    ...
    */
    getRecordRtspByTime(recordByTimeParam) {
        return new Promise((resolve,reject) => {
            API.ajaxRequest({
                url: '/api/back/monitor/jkReplayByTime',
    ...
    */
    getRecordRtspByFile(recordByFileParam) {
        return new Promise((resolve, reject) => {
            API.ajaxRequest({
                url: '/api/back/monitor/jkRecordList',
