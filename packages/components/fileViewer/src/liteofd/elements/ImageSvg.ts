...
export class ImageSvg extends BaseSvg {
	...
	private svgContainer: SVGElement | any // svg的包裹的，每个组件都有一个svg包裹，比如path带有一个，而text则是svg包裹text，然后text包裹tspan这样子
	 ...
	 * @private
	 */
	#loadImageSourceData(imgNode: XmlData): PromiseCapability<any> {
	 ...
	 * @private
	 */
	#findImageMediaData(nodeData: XmlData): PromiseCapability<any> | null {
